...
public class Animation_old extends AppCompatActivity {
    ...
    public void bilder (View view) {
        ...
        Barriers.setVisibility(View.GONE);
        Universal_Space_Concept.setVisibility(View.GONE);
        Spots.setVisibility(View.GONE);
        Modul.setVisibility(View.GONE);
        Building_Structure.setVisibility(View.GONE);
        Placeholder.setVisibility(View.GONE);
        Survival_Logic.setVisibility(View.GONE);
        Infrastructure.setVisibility(View.GONE);
        Interference_Usage_Pattern.setVisibility(View.GONE);

        if (tools.toString().equals("barriers")) {
            Barriers.setVisibility(View.VISIBLE);
        }
        if (tools.toString().equals("universal_space_concept")) {
            Universal_Space_Concept.setVisibility(View.VISIBLE);
        }
        if (tools.toString().equals("spots")) {
            Spots.setVisibility(View.VISIBLE);
        }
        if (tools.toString().equals("modul")) {
            Modul.setVisibility(View.VISIBLE);
        }
        if (tools.toString().equals("building_structure")) {
            Building_Structure.setVisibility(View.VISIBLE);
        }
        if (tools.toString().equals("placeholder")) {
            Placeholder.setVisibility(View.VISIBLE);
        }
        if (tools.toString().equals("survival_logic")) {
            Survival_Logic.setVisibility(View.VISIBLE);
        }
        if (tools.toString().equals("infrastructure")) {
            Infrastructure.setVisibility(View.VISIBLE);
        }
        if (tools.toString().equals("interference_usage_pattern")) {
